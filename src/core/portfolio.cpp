...
void portfolio::handle_order_event_concluded(const std::shared_ptr<order> &order_, std::shared_ptr<filled_order> &filled_order_)
{
...
void portfolio::handle_buy_order_event_concluded(const std::shared_ptr<order> &order_, std::shared_ptr<filled_order> &filled_order_)
{
...
void portfolio::handle_sell_order_event_concluded(const std::shared_ptr<order> &order_, std::shared_ptr<filled_order> &filled_order_)
{
  if (filled_order_->m_order_status == enums::order::fill_statuses::SUCCESS) {

...
public:
    ...
    void handle_buy_order_event_concluded(const std::shared_ptr<order> &order_,
                                          std::shared_ptr<filled_order> &filled_order_);
    void handle_sell_order_event_concluded(const std::shared_ptr<order> &order_,
                                           std::shared_ptr<filled_order> &filled_order_);
...
private:
    void
    handle_order_event_concluded(const std::shared_ptr<order> &order_, std::shared_ptr<filled_order> &filled_order_);
